...
import 'package:wanbase/common/redux/middleware/epic.dart';
import 'package:wanbase/common/redux/middleware/epic_store.dart';
...
class UserInfoMiddleware implements MiddlewareClass<BaseState>{

  @override
  void call(Store<BaseState> store, dynamic action, NextDispatcher next) {
...
class UserInfoEpic implements EpicClass<BaseState>{

  @override
  Stream<dynamic> call(Stream<dynamic> actions, EpicStore<BaseState> store) {
